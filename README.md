...
<img src="https://stuff.charm.sh/gum/demo.gif"  max-width="600px" alt="Shell running the ./demo.sh script" />
...
<img src="https://stuff.charm.sh/gum/commit_2.gif"  max-width="600px" alt="Running the ./examples/commit.sh script to commit to git" />
...
<img src="https://stuff.charm.sh/gum/customization.gif"  max-width="600px" alt="Gum input displaying most customization options" />
...
<img src="https://stuff.charm.sh/gum/input_1.gif"  max-width="600px" alt="Shell running gum input typing Not much, you?" />
...
<img src="https://stuff.charm.sh/gum/write.gif"  max-width="600px" alt="Shell running gum write typing a story" />
...
<img src="https://stuff.charm.sh/gum/filter.gif"  max-width="600px" alt="Shell running gum filter on different bubble gum flavors" />
...
<img src="https://stuff.charm.sh/gum/choose.gif"  max-width="600px" alt="Shell running gum choose with numbers and gum flavors" />
...
<img src="https://stuff.charm.sh/gum/confirm_2.gif"  max-width="600px" alt="Shell running gum confirm" />
...
<img src="https://stuff.charm.sh/gum/spin.gif"  max-width="600px" alt="Shell running gum spin while sleeping for 5 seconds" />
...
<img src="https://stuff.charm.sh/gum/style.gif"  max-width="600px" alt="Bubble Gum, So sweet and so fresh!" />
...
<img src="https://stuff.charm.sh/gum/join.gif"  max-width="600px" alt="I LOVE Bubble Gum written out in four boxes with double borders around them." />
...
<img src="https://stuff.charm.sh/gum/format.gif"  max-width="600px" alt="Running gum format for different types of formats" />
...
<img src="https://stuff.charm.sh/gum/pick-tmux-session.gif"  max-width="600px" alt="Picking a tmux session with gum filter" />
...
<img src="https://stuff.charm.sh/gum/pick-commit.gif"  max-width="600px" alt="Picking a commit with gum filter" />
