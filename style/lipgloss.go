...
func (s Styles) ToLipgloss() lipgloss.Style {
	return lipgloss.NewStyle().
		Background(lipgloss.Color(ParseColor(s.Background))).
		Foreground(lipgloss.Color(ParseColor(s.Foreground))).
		BorderBackground(lipgloss.Color(ParseColor(s.BorderBackground))).
		BorderForeground(lipgloss.Color(ParseColor(s.BorderForeground))).
