...
type Options struct {
	...
	Level      string `short:"l" help:"The log level to use" enum:"none,debug,info,warn,error,fatal" default:"none" env:"GUM_LOG_LEVEL"`
	...
	MinLevel string `help:"Minimal level to show" default:"" env:"GUM_LOG_MIN_LEVEL"`
